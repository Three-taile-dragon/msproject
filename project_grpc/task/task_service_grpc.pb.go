...
type TaskServiceClient interface {
	...
	TaskStagesSave(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskStagesSaveResponse, error)
}
...
func (c *taskServiceClient) TaskStagesSave(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskStagesSaveResponse, error) {
	out := new(TaskStagesSaveResponse)
	err := c.cc.Invoke(ctx, "/task.service.v1.TaskService/TaskStagesSave", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	TaskStagesSave(context.Context, *TaskReqMessage) (*TaskStagesSaveResponse, error)
...
func (UnimplementedTaskServiceServer) TaskStagesSave(context.Context, *TaskReqMessage) (*TaskStagesSaveResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaskStagesSave not implemented")
}
...
func _TaskService_TaskStagesSave_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskReqMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).TaskStagesSave(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.service.v1.TaskService/TaskStagesSave",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).TaskStagesSave(ctx, req.(*TaskReqMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TaskStagesSave",
			Handler:    _TaskService_TaskStagesSave_Handler,
		},
	},
